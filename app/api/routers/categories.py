...
from app.services.categories import CategoryService, CategoryNotFound

router = APIRouter(prefix="/categories", tags=["Categories"])


@router.get('/')
def show_all_categories(category_service: CategoryService = Depends(get_category_service)):
