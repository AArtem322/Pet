...
class CategoryService:
    ...
    def create_category(self, category_create: CategoryCreate) -> CategoryRead:
        category_orm = self.categories_repository.create_category(
    ...
    def update_category(
        ...
        category_for_update = self.categories_repository.get_category_by_id(
    ...
    def delete_category(self, category_id: str):
        category_for_delete = self.categories_repository.get_category_by_id(
            category_id=category_id
        )
